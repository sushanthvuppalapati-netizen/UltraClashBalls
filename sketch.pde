...
void setup() {
    exitMenuX = GameConfig.SCREEN_WIDTH - exitBtnW - 15;
    exitGameX = GameConfig.SCREEN_WIDTH - exitBtnW - 15;
    exitGameY = GameConfig.SCREEN_LENGTH - exitBtnH - 15;
...
void drawClassCard(int classIdx, float x, float y, float w, float h) {
...
void drawMapCard(int idx, float x, float y, float w, float h) {
...
void drawMapPreview(int idx, float px, float py, float pw, float ph) {
...
void drawExitButton(float x, float y) {
...
void drawPlayerCustomizer(int pIndex, float x, float y, String name) {
...
void drawOptionSelector(String label, String value, float x, float y) {
...
void drawPlayerStatsBox(float x, float y, String name, Ball b, int playerColor) {
    fill(20, 20, 25, 200);
    stroke(playerColor);
    strokeWeight(2);
    rect(x, y, 160, 95, 8);
...
void checkWeaponHits(Ball attacker, Ball defender) {
...
void handleCustomizationClick(int p, float x, float y) {
...
void setKeyState(int code, char k, boolean pressed) {
